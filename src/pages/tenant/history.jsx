...
import people from '../../assets/ten.jpg';
            ...
            {history?.status === 'success' ? (
                        ...
                        {history?.map((item, index) => (
                            <Card className="mb-3" key={index}>
                                ...
                                <div className="flex justify-between">
                                    <div>
                                        <h4 className="font-extrabold text-3xl">{item.housy.className}</h4>
                                        <p>{item.housy.address}</p>
                                        <span>{item.housy.city.name}</span>
                ...
                <>
                    <div className="flex justify-center">
                        <img className="w-[300px]" src={people} alt="" />
                    </div>
                    <h3 className="flex justify-center font-extrabold text-5xl">Please, Make an Orders!!</h3>
                </>
            )}
        </>
    );
